...
from lakeshore import ContactCheckOptimizedParameters, ResistivityOptimizedParameters, FastHallOptimizedParameters
...
resistivity_settings = ResistivityOptimizedParameters()
fasthall_settings = FastHallOptimizedParameters(magnetic_field_strength)
...
resistivity_results = my_fast_hall.run_complete_resistivity_optimized(resistivity_settings)
...
fasthall_results = my_fast_hall.run_complete_fasthall_optimized(fasthall_settings)

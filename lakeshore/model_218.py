"""Implements functionality unique to the Lake Shore model 218 temperature monitor"""
import serial
...
class Model218(GenericInstrument):
    """A class object representing the Lake Shore model 218 temperature monitor"""

    vid_pid = [(0x1FB9, 0x0200)]
